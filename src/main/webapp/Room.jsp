...
#staffInCharge {
	color: #5f7268;
} /* Ensure the font color matches other fonts */
</style>
<script>
	function showModal() {
	...
	<table>
		...
		<tbody>
			...
			try {
				...
				String sql = "SELECT r.roomId, r.roomType, r.roomStatus, r.roomPrice, s.staffName FROM room r JOIN staff s ON r.staffId = s.staffID";
			...
			<tr>
				...
				<td class="centered-select"> <label for="staffInCharge"></label> <select
...
<div id="addRoomModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Add Room</h2>
        <form action="/Admin/AddRoomServlet" method="post">
