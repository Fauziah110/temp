...
body {
	...
	color: #728687 /* Apply the color to all text */
}
...
<body>
	<div class="container">
		<div class="login-box">
			...
			<form id="loginForm" action="customerLogin.jsp" method="post">
				<div class="form-group">
					<label for="username">Username</label> <input type="text"
						id="username" name="username" placeholder="Customer Name">
				</div>

				<div class="form-group">
					<label for="password">Password</label> <input type="password"
						id="password" name="password" placeholder="Customer Password">
	...
	<script>
		function switchTab(tabName) {
			var customerForm = document.getElementById('loginForm');

			if (tabName === 'Customer') {
				customerForm.setAttribute('action', 'customerLogin.jsp');
				document.getElementById('username').setAttribute('placeholder',
						'Customer ID');
				document.getElementById('password').setAttribute('placeholder',
						'Customer Password');
			} else if (tabName === 'Admin') {
				customerForm.setAttribute('action', 'adminLogin.jsp');
				document.getElementById('username').setAttribute('placeholder',
						'Admin Name');
				document.getElementById('password').setAttribute('placeholder',
						'Admin Password');
